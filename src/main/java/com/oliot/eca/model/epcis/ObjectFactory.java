 ...
 * generated in the com.oliot.model.epcis package. 
...
public class ObjectFactory {
    ...
    private final static QName _standardBusinessDocumentHeader_QNAME = new QName("", "standardBusinessDocumentHeader");
    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.oliot.model.epcis
     * 
     */
    ...
    @XmlElementDecl(namespace = "", name = "StandardBusinessDocumentHeader")
    public JAXBElement<StandardBusinessDocumentHeader> createVocabulary(StandardBusinessDocumentHeader value) {
